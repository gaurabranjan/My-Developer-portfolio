...
//End of the naviation

//about me text
const aboutMeText = document.querySelector('.about-me-text')
const aboutMeTextContent = "I am a Web Devloper, I create webpage and websites with minimum better user experience & If you want to know more about me, Just contact me.❤️";
...
form.addEventListener("submit", e =>{
  ...
  checkEmail(email);
  checkRequiredFields([username,email,number,message]);
});
